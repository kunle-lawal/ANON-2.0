                    ...
                    <div className="profile">
                        <div className="card_container center">
                            <div className="card medium">
                                <div className="card-content">
                                    <div className="user_info center">
                                        ...
                                        <div className="info">
                                            <h3 className="name personal">Kunle Lawal</h3>
                                            <h4 className="title personal">COO Steam Boston</h4>
                                            <h4 className="location personal">Boston Ma</h4>
                                        </div>
                            ...
                            <div className="card large">
                                <div className="card-content">
                                    <nav className="profile_nav white">
                                        <div className="nav-wrapper">
                                            <ul className="left">
                                                <li style={(this.state.active === 'about') ? { color: '#bd3434', fontWeight: 600 } : null}>About Me</li>
                                                <li style={(this.state.active === 'activity') ? { color: '#bd3434', fontWeight: 600} : null}>My Activity</li>
                                                <li style={(this.state.active === 'chat') ? { color: '#bd3434', fontWeight: 600} : null}>Chat</li>
                                            </ul>
                                        </div>
                                    </nav>
